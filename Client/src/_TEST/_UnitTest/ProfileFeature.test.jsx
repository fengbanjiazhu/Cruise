import { validatePasswordChange, updatePasswordAPI, validateEmailChange } from "../../components/Profiles/updateprofile";
...
describe("Password Update Tests", () => {
  ...
  test("handles wrong password correctly", async () => {
    ...
    await expect(updatePasswordAPI("wrongPass", "new123", "token123"))
